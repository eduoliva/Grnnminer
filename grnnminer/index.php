...
<html lang="en-US" xml:lang="en-US">
	...
	<div id="respuestaTarget"></div>
        ...
        <form action="http://webdemos.sinc.unl.edu.ar:8081/#" style="position: absolute;right:1.8%;top:0.5%;">
    ...
    ?>
        ...
        <div class="optionParameters" id="optionParameters">
            ...
            <form action="" method="POST" enctype="multipart/form-data" target="contenedor_subir_archivo_data" style="margin-left: 1.8%;">
                ...
                <p2>NN Type:
                <select name="NN">
                    <?php if($_SESSION['NN']==='MLP'){ ?> <!-- if necesario para poder cambiar el select cuando cargo un archivo con parámetros-->
                ...
                <input type="submit" name="botonLoadParameters" value="Load" />
                <h2></h2>
                <input type="submit" name="botonParameters" value="Save Parameters" />
